...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <form action="save">
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Choose Pizza Type</label>
                <select class="form-select" name="type" aria-label="Default select example">
                    <option value="Cheese Burger" selected>Cheese Burger</option>
                    <option value="Chicken Hawaiian">Chicken Hawaiian</option>
                    <option value="Meat Deluxe">Meat Deluxe</option>
                    <option value="Veg Feast">Veg Feast</option>
                </select>
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Choose Base Type</label>
                <select class="form-select" name="base" aria-label="Default select example">
                    <option value="Cheese" selected>Cheese</option>
                    <option value="Chicken">Chicken</option>
                    <option value="Meat">Meat</option>
                    <option value="Veg">Veg Feast</option>
                </select>
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Extra Toppings</label>
